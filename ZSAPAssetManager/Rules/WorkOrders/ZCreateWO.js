...
export default async function ZCreateWO(context) {
  try {
      ...
      let localWO = year.toString() + month.toString().padStart(2, '0') + day.toString().padStart(2, '0') + hours.toString().padStart(2, '0') + minutes.toString().padStart(2, '0')
    ...
    return context.executeAction({'Name': '/ZSAPAssetManager/Actions/WorkOrders/ZWorkOrderCreate.action', 'Properties': {
                            ...
                            "Headers": {
                                ...
                                "OfflineOData.TransactionID": localWO
                            }
                        },
                    }).then(actionResult => {
